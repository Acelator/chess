...
public:
	...
	U64 getPawns(Utils::Color color);
	U64 getBishops(Utils::Color color);
	U64 getKnights(Utils::Color color);
	U64 getRooks(Utils::Color color);
	U64 getQueen(Utils::Color color);	
	U64 getKing(Utils::Color color);
};
